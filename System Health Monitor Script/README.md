...
Overview
A lightweight Bash-based monitoring utility designed to automate routine system health checks. This script provides real-time visibility into disk usage and critical service status with automated timestamp logging.
