# Progress updates, summary and notes 
Here i'll be dropping some of my personal updates randomly
...
learnt about `prompt programming` and how it is important to be precise with you prompt and detail it properly and when inputting commands into generative ai don't be `verbose`, "Avoid verbosity when writing prompts for generative AI."
